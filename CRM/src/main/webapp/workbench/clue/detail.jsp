	...
	$(function(){
		...
		$("#activityName").keydown(function (event) {
			if(event.keyCode==13){
				...
				$.ajax({
					url:"clue/getAcLikeNameAndNoByClueId.do",
					data:{
		 ...
		 */
		$("#searchBody").on("click",$("input[name=check]"),function () {
		...
		$.ajax({
			...
			success:function (resp) {
				...
				$.each(resp,function (index, e) {
					...
					html+='<td>'+e.endDate+'</td>'
					html+='<td>'+e.owner+'</td>'
					html+='<td><a href="javascript:void(0);"  onclick="disassociate(\''+e.id+'\')" style="text-decoration: none;"><span class="glyphicon glyphicon-remove"></span>解除关联</a></td>'
					html+='</tr>'
		...
		<div class="modal-dialog" role="document" style="width: 80%;">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary" id="rBtn">关联</button>
				</div>
			</div>
		</div>
	</div>
