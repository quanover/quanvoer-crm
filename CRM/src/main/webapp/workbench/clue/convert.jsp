...
<script type="text/javascript">
	$(function(){
		...
		//模态窗体的模糊查
		$("#likeSearch").keydown(function (event) {
			if(event.keyCode==13){
				$.ajax({
					url:"clue/getActivityLikeName.do",
					data:{
						"name":$.trim($("#likeSearch").val())
					},
					dataType:"json",
		...
		$("#changeBtn").click(function () {
			if($("#isCreateTransaction").prop("checked")){
				...
				window.location.href="clue/change.do?clueId=${param.id}"
			}
		})
	});
</script>
...
<body>
					...
					<div class="btn-group" style="position: relative; top: 18%; left: 8px;">
						<form class="form-inline" role="form">
						  <div class="form-group has-feedback">
						    <input id="likeSearch" type="text" class="form-control" style="width: 300px;" placeholder="请输入市场活动名称，支持模糊查询">
	...
	<div id="create-transaction2" style="position: relative; left: 40px; top: 20px; width: 80%; background-color: #F7F7F7; display: none;" >
		...
		<form id="tranForm" action="clue/change.do" method="post">
	...
	<div id="operation" style="position: relative; left: 40px; height: 35px; top: 100px;">
		<input class="btn btn-primary" type="button" value="转换" id="changeBtn">
		&nbsp;&nbsp;&nbsp;&nbsp;
